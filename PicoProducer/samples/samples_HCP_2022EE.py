...
# DYto2Tau_MLL_1500to2500_powheg/    DYto2Tau_MLL_4000to6000_powheg/    DYto2Tau_MLL_6000_powheg/
  ...
  M('DY','DYto2E_MLL_6000_powheg',
    ...
    # H->tautau
    # M('HTT','GluGluHTo2Tau_UncorrelatedDecay_CPodd_UnFiltered_ProdAndDecay', "/GluGluHTo2Tau_UncorrelatedDecay_CPodd_UnFiltered_ProdAndDecay", store=storage, url=url, files=filelist, opts="useT1=False"),
    # M('HTT','GluGluHTo2Tau_UncorrelatedDecay_MM_UnFiltered_ProdAndDecay', "/GluGluHTo2Tau_UncorrelatedDecay_MM_UnFiltered_ProdAndDecay", store=storage, url=url, files=filelist, opts="useT1=False"),
    # M('HTT','GluGluHTo2Tau_UncorrelatedDecay_SM_UnFiltered_ProdAndDecay', "/GluGluHTo2Tau_UncorrelatedDecay_SM_UnFiltered_ProdAndDecay", store=storage, url=url, files=filelist, opts="useT1=False"),
    # M('HTT','ZHToTauTau_UncorrelatedDecay_UnFiltered', "/ZHToTauTau_UncorrelatedDecay_UnFiltered", store=storage, url=url, files=filelist, opts="useT1=False"),
    # M('HTT','GluGluHTo2Tau_UncorrelatedDecay_UnFiltered', "/GluGluHTo2Tau_UncorrelatedDecay_UnFiltered", store=storage, url=url, files=filelist, opts="useT1=False"),
    # M('HTT','WplusHToTauTau_UncorrelatedDecay_UnFiltered', "/WplusHToTauTau_UncorrelatedDecay_UnFiltered", store=storage, url=url, files=filelist, opts="useT1=False"),
    # M('HTT','WminusHToTauTau_UncorrelatedDecay_UnFiltered', "/WminusHToTauTau_UncorrelatedDecay_UnFiltered", store=storage, url=url, files=filelist, opts="useT1=False"),
    # M('HTT','VBFHToTauTau_UncorrelatedDecay_UnFiltered', "/VBFHToTauTau_UncorrelatedDecay_UnFiltered", store=storage, url=url, files=filelist, opts="useT1=False"),
    M('HTT','GluGluHTo2Tau_UncorrelatedDecay_CPodd_Filtered_ProdAndDecay', "/GluGluHTo2Tau_UncorrelatedDecay_CPodd_Filtered_ProdAndDecay", store=storage, url=url, files=filelist, opts="useT1=False"),
    M('HTT','GluGluHTo2Tau_UncorrelatedDecay_MM_Filtered_ProdAndDecay', "/GluGluHTo2Tau_UncorrelatedDecay_MM_Filtered_ProdAndDecay", store=storage, url=url, files=filelist, opts="useT1=False"),
    M('HTT','GluGluHTo2Tau_UncorrelatedDecay_SM_Filtered_ProdAndDecay', "/GluGluHTo2Tau_UncorrelatedDecay_SM_Filtered_ProdAndDecay", store=storage, url=url, files=filelist, opts="useT1=False"),
    M('HTT','ZHToTauTau_UncorrelatedDecay_Filtered', "/ZHToTauTau_UncorrelatedDecay_Filtered", store=storage, url=url, files=filelist, opts="useT1=False"),
    M('HTT','GluGluHTo2Tau_UncorrelatedDecay_Filtered', "/GluGluHTo2Tau_UncorrelatedDecay_Filtered", store=storage, url=url, files=filelist, opts="useT1=False"),
    M('HTT','WplusHToTauTau_UncorrelatedDecay_Filtered', "/WplusHToTauTau_UncorrelatedDecay_Filtered", store=storage, url=url, files=filelist, opts="useT1=False"),
    M('HTT','WminusHToTauTau_UncorrelatedDecay_Filtered', "/WminusHToTauTau_UncorrelatedDecay_Filtered", store=storage, url=url, files=filelist, opts="useT1=False"),
    M('HTT','VBFHToTauTau_UncorrelatedDecay_Filtered', "/VBFHToTauTau_UncorrelatedDecay_Filtered", store=storage, url=url, files=filelist, opts="useT1=False"),
